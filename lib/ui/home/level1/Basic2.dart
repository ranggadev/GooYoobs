...
class _Basic2State extends State<Basic2> {
  ...
  List<_FoodModel> _foodModel = [
    _FoodModel(
        "https://i1.wp.com/www.romadecade.org/wp-content/uploads/2019/07/ternak-kambing.jpg",
        "Wedhus",
        "Ula",
        "Menthog",
        "Lemper",
    ...
    _FoodModel(
        "https://www.batamnews.co.id/foto_berita/83kuda.jpg",
        "Pitik",
        "Jaran",
        "Munyuk",
        "ketupa",
    ...
    _FoodModel(
        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQuGobuNtCdOoVj-RMupmut-ZjzP02jRZBx0J4fnaizgygdguav&s",
        "jengkelong",
        "Piyik",
        "gonggo",
        "gendhot",
