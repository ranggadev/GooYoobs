...
class _Basic3State extends State<Basic3> {
  ...
  List<_FoodModel> _foodModel = [
    _FoodModel(
        "https://asset-a.grid.id//crop/0x0:0x0/700x465/photo/bobofoto/original/4013_foto-imaginesyawordpresscom.jpg",
        "Bekel",
        "Congklak",
        "Gatrik",
        "boian",
    ...
    _FoodModel(
        "https://ecs7.tokopedia.net/blog-tokopedia-com/uploads/2018/02/main6.jpg",
        "Egrang",
        "Engklek",
        "Gasing",
        "Sodor",
    ...
    _FoodModel(
        "https://ecs7.tokopedia.net/blog-tokopedia-com/uploads/2018/02/main7.jpg",
        "Hulahop",
        "Sodor",
        "Kasti",
        "Gatrik",
              ...
              child: ListView(
                ...
                children: <Widget>[
                  ...
                  Padding(
                    padding: const EdgeInsets.all(16.0),
                    child: Text(
                      "Apakah nama permainan dibawah ini?",
                      softWrap: true,
                      style: TextStyle(
                          fontSize: MyFontSize.large
                      ),
